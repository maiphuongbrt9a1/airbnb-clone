...
<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path
    d="M14 31.2L32 16L50 31.2V48C50 49.1046 49.1046 50 48 50H39.2V36.8H24.8V50H16C14.8954 50 14 49.1046 14 48V31.2Z"
    fill="white"
  />
    ...
    <main className="mx-auto flex min-h-[88vh] max-w-5xl items-center px-4 md:px-8">
      <section className="grid w-full overflow-hidden rounded-3xl border border-ink-200 bg-surface shadow-sm md:grid-cols-2">
        <div className="bg-gradient-to-br from-brand-50 via-white to-brand-100 p-8 md:p-10">
          ...
          <div className="mt-8 space-y-3 text-sm text-ink-700 ">
            <p className="flex items-center gap-2 ">
              <House className="h-4 w-4 text-brand-500"></House>
              Personalized home recommendations.
            </p>
            <p className="flex items-center gap-2 ">
              <ShieldCheck className="h-4 w-4 text-brand-500"></ShieldCheck>
              Secure account access.
            </p>
            <p className="flex items-center gap-2 ">
              <Sparkles className="h-4 w-4 text-brand-500"></Sparkles>
        ...
        <div className="p-8 md:p-10 ">
          ...
          <form className="mt-5 space-y-3" onSubmit={onCredentialsLogin}>
            <input
              type="email"
              required
    ...
    <main className="mx-auto flex min-h-[88vh] max-w-5xl items-center px-4 py-8 md:px-8">
      <section className="grid w-full overflow-hidden rounded-3xl border border-ink-200 bg-surface shadow-sm md:grid-cols-2">
        ...
        <div className="bg-gradient-to-br from-brand-100 via-brand-50 to-white p-8 md:p-10">
          ...
          <div className="mt-8 space-y-3 text-sm text-ink-700 ">
            ...
            <p className="flex items-center gap-2">
              ...
              Manage bookings from single dashboard
            </p>
            <p className="flex items-center gap-2">
        ...
        <div className="p-8 md:p-10">
          ...
          <p className="mt-1 text-sm text-ink-600">
            Join StayScape to host home or reserve stays
          </p>
...
export function UserMenu({
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        <Menu className="h-4 w-4 text-ink-700 "></Menu>
        <UserCircle2 className="h-6 w-6 text-ink-500" />
      </button>

      {open ? (
        <div className="absolute right-0 top-12 z-50 w-48 rounded-2xl border border-ink-200 bg-surface p-2 shadow-sm ">
    ...
    <div className="w-full">
      <div className="mb-4 flex items-center justify-center gap-2">
        <button
          ...
          onClick={() => {
            return setMonth((prev) => addMonths(prev, -1));
          }}
        >
...
export function HomeSearchBar({
  ...
  useEffect(() => {
    ...
    const syncViewPort = () => {
      return setIsDesktopViewPort(mediaQuery.matches);
    };
    syncViewPort();
  ...
  return (
    <div className="relative rounded-[32px] bg-surface p-2.5 shadow-sm md:border md:border-ink-200 md:p-4">
      {/* active panel */}
      {/* Full screen scrim behind panels on mobile; click to dismiss */}
      {activePanel ? (
        <button
          type="button"
      ...
      <form
        action=""
        className="rounded-[28px] border border-ink-300 p-2.5 shadow-sm md:rounded-full md:p-1.5"
      >
        ...
        <div className="hidden gap-1 md:grid md:grid-cols-[1.5fr_1.5fr_1.5fr_auto]">
          <button
            type="button"
        ...
        {/* Synced the url on submit; homepage server component reads searchParams */}
        ...
        {activePanel === "where" ? (
          <div className="fixed inset-0 z-20 flex items-center justify-center p-4 md:absolute md:inset-auto md:left-3 md:top-[88px] md:block md:w-[420px]">
...
export function SafeImage({
  ...
  return (
    <Image
      ...
      priority={priority}
      onError={() => {
        return setFailedSources((prev) => {
          return { ...prev, [requestedSource]: true };
        });
      }}
    />
  );
...
````json
{
  ...
  "skills": {
    "prisma-cli": {
      ...
      "computedHash": "f41a5af7f25a686631a0e2a8b7031f3c57e0e06b81932f6389736d930d05fa54"
    },
    "prisma-client-api": {
      "source": "prisma/skills",
      "sourceType": "github",
      "skillPath": "prisma-client-api/SKILL.md",
      "computedHash": "7825288518e0722b497de03367a1aee477fc61b0b488d456b9b6257294c005ae"
    },
    "prisma-compute": {
      "source": "prisma/skills",
      "sourceType": "github",
      "skillPath": "prisma-compute/SKILL.md",
      "computedHash": "b2e1d4b2fda6f523b2eb4a38e25c12b7800e4a2801a97b750e95df8131addec0"
    },
    "prisma-database-setup": {
      "source": "prisma/skills",
      "sourceType": "github",
    ...
    "prisma-driver-adapter-implementation": {
      ...
      "computedHash": "86034220752575ac0551aa3d579ed0bdfb90616000ae5703bf11e47b655ec7d1"
    },
    "prisma-mongodb-upgrade": {
      "source": "prisma/skills",
      "sourceType": "github",
    ...
    "prisma-postgres": {
      ...
      "computedHash": "66dc44132bdb85cfa369e21a8512c6427c574f5186c8631d345aca9b111091c1"
    },
    "prisma-postgres-setup": {
      "source": "prisma/skills",
      "sourceType": "github",
...
@theme {
  ...
  --color-brand-100: #ffe0e8;
  --color-brand-200: #ffc2d2;
  --color-brand-300: #ff97b1;
  --color-brand-400: #ff5d86;
  --color-brand-500: #ff385c;
  --color-brand-600: #e61e4d;
  --color-brand-700: #c41840;
...
.hero-daypicker .rdp-months {
  justify-content: center;
}

.hero-daypicker .rdp-day_disabled {
  color: var(--color-ink-300);
  text-decoration: line-through;
  opacity: 0.75;
}

.hero-daypicker .rdp-day:focus-visible {
...
.compact-uploadthing [data-ut-element="dropzone"] {
  min-height: 150px !important;
  height: 150px !important;
...
.compact-uploadthing svg {
  width: 42px !important;
  height: 42px !important;
}

.compact-uploadthing button {
  margin-top: 0.2rem !important;
}

@keyframes hostListingCardIn {
  from {
    opacity: 0;
...
.host-listing-card {
  opacity: 0;
  animation: hostListingCardIn 420ms cubic-bezier(0.22, 1, 0.36, 1) forwards;
